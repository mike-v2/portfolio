      ...
      <div className='flex flex-col gap-y-4'>
        ...
        <ul className='flex list-decimal flex-col gap-y-3 ps-4'>
          ...
          <li>
            ...
            A session cookie, with a unique session ID, is generated by
            Express-Session.
          </li>
          <li>
            <h6 className='font-medium'>
          ...
          <li>
            <h6 className='font-medium'>Send response to front end</h6>
            The server sends the response back to the client, typically
            redirecting the user to a protected page or sending a success
            message.
          </li>
        </ul>
