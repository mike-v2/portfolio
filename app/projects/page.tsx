...
const projectData = [
  {
    ...
    features: [<p><span className='font-bold'>createElement</span> transforms JSX into ReactElement objects</p>, <p><span className='font-bold'>render</span> brings ReactElements to life on the DOM</p>, <p><span className='font-bold'>useState</span> manages state</p>, <p><span className='font-bold'>useEffect</span> synchronizes the component with an external system</p>],
